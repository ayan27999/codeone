...
are here [sql.com](link).

* Before upload the database I have to clean all the dataset. To over come errors
and wrong result. this time I will use the LibreOffice Calc. and all the process
I will showcase by a Video link is here. [ libreoffice.sql](link)
  -- And all the change log are documented is here [ nextcloud.calc ](link)
